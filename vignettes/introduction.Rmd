...
plot(img_bw)
highlight(contour_points, col = "orange")
segments(reliable_contour_points_df$x, reliable_contour_points_df$y, centroid$x1, centroid$y1, col = "darkorchid1", lwd = .2)
```
...
```{r}
img_rot <- rotate_xy(img_bw, 180 - ellipse$Angle, cx = ellipse$CenterX, cy = ellipse$CenterY, boundary = 1) %>%
  pad(50, axes = "xy", val = 1)
