...
The functions in this vignette were borrowed with permission from Vinces Gaitan's blog post: https://www.kaggle.com/vicensgaitan/image-registration-the-r-way/notebook

I have modified them where necessary in order to make them more pipeline-friendly and function oriented.
